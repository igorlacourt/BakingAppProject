package com.bakingapp.lacourt.bakingapp.model;
...
public class JsonResponse {
    public final static String JSON_RESPONSE = "[\n" +
            "  {\n" +
            "    \"id\": 1,\n" +
            "    \"name\": \"Nutella Pie\",\n" +
            "    \"ingredients\": [\n" +
            ...
            "      {\n" +
            "        \"id\": 0,\n" +
            "        \"shortDescription\": \"RecipeAdapter Introduction\",\n" +
            "        \"description\": \"RecipeAdapter Introduction\",\n" +
    ...
    public static ArrayList<RecipesResponse> recipesResponses = null;

    public static void getArrays() {

        recipesResponses = new ArrayList<>();

        recipesResponses.addAll(getResponse());

    }


    public static Collection<RecipesResponse> getResponse(){

        Gson gson = new Gson();
        Type collectionType = new TypeToken<Collection<RecipesResponse>>(){}.getType();
        Collection<RecipesResponse> response = gson.fromJson(JSON_RESPONSE, collectionType);
